...
images: ['/static/images/clean-android/jetpack-card.png']
---
...
Trong quá trình phát triển bộ mã nguồn này, tôi xin cảm ơn tác giả [Mesut G](https://developersancho.medium.com/). Bài viết của bạn rất hữu ích, đã thay đổi quan điểm của tôi về Clean Architecture.

Mặc dù đã từng sử dụng các mô hình như MVVM, MVC, MVP, TCA trong việc phát triển ứng dụng Mobile cho khách hàng, nhưng đến hiện tại tôi cảm thấy MVVM vẫn có tính ứng dụng cao nhất trong việc kiểm thử và dễ dàng duy trì. Điều quan trọng nhất là nó có khái niệm `use case`, tôi có thể bóc tách chúng từ các `user story` để thiết kế tài liệu cơ bản.
...
![Màn Hình Khởi Động](/static/images/clean-android/login-android.png)
**Màn Hình Khởi Động**

### Chế Độ Sáng

![Chế Độ Sáng](/static/images/clean-android/register-android.png)
**Chế Độ Sáng**

### Chế Độ Tối

![Chế Độ Tối](/static/images/clean-android/register-android.png)
**Chế Độ Tối**
...
- **App**: chứa giao diện như view, activity, viewmodel, xử lý logic nghiệp vụ,...
...
[MIT](https://github.com/samyoney/compose_clean_base/blob/develop/LICENSE) © [Yoneyama SAM](https://www.timrlx.com)
